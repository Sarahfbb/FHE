...
def main():
    ...
    train_features, train_targets = np.load('train_features.npy'), np.load('train_targets.npy')
    val_features, val_targets = np.load('val_features.npy'), np.load('val_targets.npy')
    test_features, test_targets = np.load('test_features.npy'), np.load('test_targets.npy')
